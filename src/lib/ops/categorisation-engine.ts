// Pure scoring engine for document auto-categorisation.
// Zero framework dependencies — importable by both TanStack Start server
// functions (simulator) and the Supabase Edge Function (processor).

import { classify, calibrateConfidence, isModelReady, type NbModel } from "./categorisation-ml";
